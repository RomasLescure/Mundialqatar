            ...
            <form action="registro.php" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <br><input type="radio" onclick="javascript:yesnoCheck();" value="pred" id="pred" name="tipo">
                        ...
                        contraseña -->
                        <br><input type="radio" onclick="javascript:yesnoCheck();" value="admin" id="admin" name="tipo">
